...
const RenewalSection = ({ userPolicy }) => {
    ...
    return (
        <>
            <div id="r1" className="relative hero min-h-screen bg-insurify-4">
                <div className="hero-content flex-col lg:flex-row">
                    ...
                    <div className="max-w-3xl mobile:text-center">
                        ...
                        <p className="text-insurify-summary-text text-2xl font-bold pt-4">
                            <>
                                Your policy ends in <span className="text-insurify-purple text-5xl">{daysUntilRenewal}</span> days!
                                <br></br>
                                Ready for more? Secure another year of exceptional care and renew today to <span className="text-white">save {userPolicy.product.discount} on your next premium</span>. Don't miss out on continuous coverage and savings!
                            </>
                        </p>
                        {/* This could be a button that starts the renewal process */}
                        <a href="https://www.allstate.com/help-support/billing-payments" target="_blank" rel="noopener noreferrer">
                            <button className="mt-4 bg-insurify-purple text-white font-bold py-2 px-4 rounded-box mobile:ml-0 tablet:ml-0">
                                Renew Now
                            </button>
                        </a>
                    </div>
