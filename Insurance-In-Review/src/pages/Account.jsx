    ...
    <div>
      {isLoggedIn && (
        ...
        >
          ...
          <div className="hero min-h-screen flex justify-center items-start">
            <div className="max-w-full w-full">
              ...
              <div className="hero flex w-full min-h-screen">
                <div className="w-1/6 min-h-screen ml-32 border-r-2 border-insurify-grey-2">
