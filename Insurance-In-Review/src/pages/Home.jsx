    ...
    <div>
      ...
      >
        ...
        <div className="hero min-h-screen">
          <div className="hero-content flex-col lg:flex-row-reverse">
            <img
              src="/Dark Mobile App.png"
              className="max-w-sm rounded-lg shadow-4xl w-60"
            />
            <img
              src="/Light Mobile App.png"
      ...
      <div
        ...
        style={{
          ...
          background: "linear-gradient(0deg, rgba(94, 23, 235, 0.9), #ffffff 60%)",
        }}
      >
        <div className="hero-overlay bg-opacity-5"></div>
        <div className="hero min-h-screen">
      <div className="hero-content flex-col lg:flex-row-reverse">
            ...
            <div>
              ...
              <p className="mb-5 text-insurify-grey text-xl">
              Mobilize Your Peace of Mind: Simplicity, Security, and Seamless <br />
              Safeguarding, All in One Snapshot! - Discover the app that will <br />
