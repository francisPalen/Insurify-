...
func (u *UserServiceImpl) UpdateUser(user *models.User) error {
	...
	update := bson.D{primitive.E{Key: "$set", Value: bson.D{primitive.E{Key: "firstName", Value: user.FirstName}, primitive.E{Key: "lastName", Value: user.LastName}, primitive.E{Key: "username", Value: user.UserName}, primitive.E{Key: "password", Value: user.Password}, primitive.E{Key: "email", Value: user.Email}, primitive.E{Key: "phoneNo", Value: user.PhoneNo}}}}
